...
static func __zidF(__OW3O : String) -> String:
	var __kPp2 : String
	var __0LTr : PackedStringArray = __OW3O.split("\n")
	for line in __0LTr:
		var __Pqdi : int = line.find("(")
		if __Pqdi != -1:
			__kPp2 += '\n"' + line.substr(0, __Pqdi).replace(" ", "") + '",'
	return __kPp2
